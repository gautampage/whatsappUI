...
git config --global --add safe.directory /opt/apps/chat-app

echo pwd
# Navigate to the directory
echo "----------------------- Changing directory to /opt/apps/chat-app... -----------------------"
...
git reset --hard && git checkout release/whatsapp-qa && git pull --all
...
echo "----------------------- Restarting the pm2 process for 'chat-application'... -----------------------"
